 ...
 */
public abstract class NewSensorsFragment extends Fragment implements
	...
	private static Sensor sensorOrietation = null;
	...
	public void onSensorChanged(SensorEvent evt) {
		...
		if (GlobalFunctions.isLargeSize(mActivity)) {
			//SensorManager.remapCoordinateSystem(temp, SensorManager.AXIS_Z,SensorManager.AXIS_MINUS_X, rotation);
