...
//	private Bitmap compassImageSouth;
	...
	public ResearchAdapter(Activity activity, List<MyDataHolder> data) {
		this.mActivity = activity;
		this.data.addAll(data);
		Logger.d(tag, "Enter ResearchAdapter()");
...
//				R.drawable.s_arrow);
		Logger.d(tag, "Exit ResearchAdapter()");
	}
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		// Assign Values
		if (researchObject.getType().equalsIgnoreCase("location")) {
			subcategory.setText(researchObject.getSubCategory().getName() + "");
			title.setText(researchObject.getLoc_title());
			website.setText(researchObject.getLoc_site());
			description.setText("Text:" + researchObject.getLoc_link());
		} else if (researchObject.getType().equalsIgnoreCase("events")) {
			subcategory.setText("Eventos");
			title.setText(researchObject.getName() + " - "
					+ researchObject.getDate() + " - "
					+ researchObject.getTime());
			description.setText(researchObject.getLoc_title());
			website.setVisibility(View.GONE);
		} else if (researchObject.getType().equalsIgnoreCase("promotions")) {
			subcategory.setText("Promoção");
			title.setText(researchObject.getName());
			if (researchObject.getDescription() != null
					&& !researchObject.getDescription().equals(""))
				description.setText(researchObject.getDescription());
			else
				description.setVisibility(View.GONE);
			website.setText(researchObject.getLoc_site());
		} else if (researchObject.getType().equalsIgnoreCase("category")) {
			subcategory.setText(researchObject.getCategory().getName() + "");
			title.setText(researchObject.getLoc_title());
			description.setText("Text:" + researchObject.getLoc_link());
			website.setText(researchObject.getLoc_site());
		} else if (researchObject.getType().equalsIgnoreCase("subcategory")) {
			subcategory.setText(researchObject.getSubCategory().getName() + "");
			title.setText(researchObject.getLoc_title());
			description.setText("Text:" + researchObject.getLoc_link());
			website.setText(researchObject.getLoc_site());
		...
		desiredLocation.setLatitude(researchObject.getLoc_latitude());
		desiredLocation.setLongitude(researchObject.getLoc_longitude());
		distance.setText(""
		...
		convertView.setTag(researchObject);
		return convertView;
	}
	private synchronized void updateArrow(final ImageView imageView,MyBaseDataHolder location) {
