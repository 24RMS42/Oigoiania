...
public class PaintableBoxedText extends PaintableObject {
    ...
    public PaintableBoxedText(String txtInit, float fontSizeInit, float maxWidth,Bitmap bitmap) {
        this(txtInit, fontSizeInit, maxWidth, Color.rgb(255, 255, 255), Color.argb(128, 0, 0, 0), Color.rgb(255, 255, 255));
        this.bitmap=bitmap;
    }
    ...
    public void paint(Canvas canvas) {
        ...
        paintRect(canvas, 0, 0, areaWidth+15, bitmap.getHeight());
        //paintRoundedRect(canvas, 0, 0, width, height);

       // setFill(false);
       // setColor(borderColor);
       // paintRect(canvas, 0, 0, areaWidth+60, areaHeight+15);
      //  paintRoundedRect(canvas, 0, 0, width, height);
       ...
       // Log.d("pad", "areaWidth :"+areaWidth+" Height :"+areaHeight+" Pad :"+pad+" getTextAsc() ="+getTextAsc());
        paint.setColor(backgroundColor);
       // canvas.drawRect(areaWidth+15,  0, areaWidth+65, areaHeight+15, paint);
        canvas.drawRect(areaWidth+15,  0, areaWidth+15+bitmap.getWidth(), bitmap.getHeight(), paint); //areaWidth+areaHeight+30 for square
        if(paint!=null)
            canvas.drawBitmap(bitmap, areaWidth+15,  0, paint);
            else
            	Log.d("PaintableBoxedText", "paint is null");
    }
