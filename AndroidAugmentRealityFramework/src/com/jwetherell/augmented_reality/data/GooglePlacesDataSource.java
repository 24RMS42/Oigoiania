...
public class GooglePlacesDataSource extends NetworkDataSource {
	...
	public String createRequestURL(double lat, double lon, double alt, float radius, String locale) {
		try {
			Log.d("test", "String is :"+URL + "location="+lat+","+lon+"&radius="+(radius*1000.0f)+"&types="+TYPES+"&sensor=true&key="+key);
			Log.d("test", "Data url is :"+URL + "?lat=" + lat + "&lng=" + lon + "&radius=" + radius + "&maxRows=40" + "&lang=" + locale);
